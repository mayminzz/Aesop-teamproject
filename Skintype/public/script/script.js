...
const questions = [
  {
    question: "1. 세안 후 아무것도 바르지 않은 피부 상태를 알려주세요.",
    options: [
      "당기고 건조하다",
      "산뜻하고 부드럽다",
  ...
  {
    question: "2. 평소 사진에선 피부가 어떻게 보여지나요?",
    options: [
      "피부에서 빛이 나지 않는다",
      "때때로 빛이 난다",
      "자주 빛이 난다",
  ...
  {
    question: "3. 메이크업 파운데이션 후 2~3시간 후 상태는 어떠한가요?",
    options: [
      "각질이 있거나 주름이 진다",
      "매끄럽다",
      "광택이 난다",
  ...
  {
    question: "4. 수분이 많지 않을 때 얼굴 피부가 팽팽하게 느껴질때가 있나요?",
    options: [
      "항상 그렇다",
      "때때로 그렇다",
      "거의 그렇지 않다",
  ...
  {
    question: "5. T존 (이마와 코)에 유분기가 있나요?",
  ...
  if (result == "건성") {
    fetch(skinInfoURL)
      ...
      .then((json) => {
        ...
        skinBtn.innerHTML = "<span>추천제품 보러가기</span>";
        ...
        skinBtn.addEventListener("click", () => {
          ...
          <div class="product_txt">
            ...
            <p>
              건조함 없이 모공까지 깨끗하게 세정해주며, 자극이 적고
              효과적으로 피부를 진정시켜주어 문제성 피부 관리에도 적합한 딥
              클렌징 마스크 사이즈.
            </p>
            <span>₩55,000</span>
            <div class="prod_btns">
              <button
                class="prod"
                onclick="alert('카트에 추가되었습니다.')"
              >
                카트 추가
              </button>
              <button
                class="buy"
                onclick="alert('구매하기 창으로 이동합니다')"
              >
                바로 구매
              </button>
            </div>
